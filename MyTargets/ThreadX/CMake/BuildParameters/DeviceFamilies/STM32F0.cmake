...
target_link_options(nanoCLR PUBLIC "-T${CMAKE_SOURCE_DIR}/MyTargets/ThreadX/${TARGET_BOARD}/Linker_script.ld")
set_target_properties(nanoCLR PROPERTIES LINK_DEPENDS "${CMAKE_SOURCE_DIR}/MyTargets/ThreadX/${TARGET_BOARD}/Linker_script.ld")
